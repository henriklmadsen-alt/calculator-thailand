...
export const CALCULATOR_AFFILIATE_MAP: Record<string, string> = {
  ...
  '/คำนวณค่าไฟฟ้า/': 'roojai-partners',
  '/คำนวณ-klc0577-ค่าไฟฟ้า-mea/': 'roojai-partners',
  '/คำนวณความสิ้นเปลืองไฟฟ้า/': 'roojai-partners',
  '/คำนวณค่าไฟโซลาร์เซลล์/': 'roojai-partners',
  '/คำนวณต้นทุนชาร์จรถไฟฟ้า/': 'roojai-partners',
  '/คำนวณ-klc0576-โซลาร์-roi/': 'roojai-partners',
  '/คำนวณ-klc0582-ประหยัดไฟ/': 'roojai-partners',
  '/คำนวณ-klc0581-ไฟฟ้าประหยัด/': 'roojai-partners',
  '/คำนวณขนาดเครื่องปั่นไฟสำรอง/': 'roojai-partners',
  '/คำนวณจำนวนแผงโซลาร์/': 'roojai-partners',
  '/คำนวณต้นทุนอัพเกรดแผงไฟฟ้า/': 'roojai-partners',
  '/คำนวณประหยัดจากการติดตั้งแผง-solar/': 'roojai-partners',
  '/คำนวณประหยัดจากพลังงานหลอด-led/': 'roojai-partners',
  '/คำนวณงบค่าสาธารณูปโภค/': 'roojai-partners',
  '/คำนวณต้นทุนยูทิลิตี้บ้าน/': 'roojai-partners',
