...
export const PRIMARY_TRAFFIC_CLUSTERS: KeywordConquestCluster[] = [
  ...
  },
  {
    ...
    primaryThaiQueries: ['วิธีคิดโอที', 'โอที 1.5 คือ', 'โอที 1.5 เท่า คิดยังไง', 'เงินเดือน 15000 โอที 10 ชั่วโมง', 'โอที 3 เท่า คิดยังไง'],
  ...
  },
  {
    ...
    quickSearchLabel: 'เงินเดือนสุทธิ',
    primaryThaiQueries: ['เงินเดือน 30000 รับสุทธิเท่าไร', 'เงินเดือน 50000 เสียภาษีเท่าไหร่', 'เงินเดือน 20000 เสียภาษีไหม'],
    englishQueries: ['net salary calculator thailand', 'thai salary tax calculator'],
    longTailPatterns: ['รับสุทธิ', 'เสียภาษีไหม', 'หักประกันสังคม', 'เงินเดือน 30000', 'เงินเดือน 50000'],
    gscSignal: 'core salary calculator cluster; exact-answer pages should improve CTR and featured-answer eligibility',
    nextAction: 'Keep exact salary pages linked from calculator, salary hub, article index, and LLM context.',
  },
  {
    id: 'bmi',
    name: 'BMI',
...
export const EXACT_NUMBER_QUERY_ROUTES = [
  { query: 'เงินเดือน 20000 เสียภาษีไหม', href: '/บทความ/เงินเดือน-20000-เสียภาษีไหม/' },
  { query: 'เงินเดือน 25000 รับสุทธิเท่าไร', href: '/บทความ/เงินเดือน-25000-รับสุทธิเท่าไร/' },
  { query: 'เงินเดือน 30000 รับสุทธิเท่าไร', href: '/บทความ/เงินเดือน-30000-รับสุทธิเท่าไร/' },
  { query: 'เงินเดือน 30000 เสียภาษีเท่าไหร่', href: '/บทความ/เงินเดือน-30000-เสียภาษีเท่าไหร่/' },
  { query: 'เงินเดือน 40000 รับสุทธิเท่าไร', href: '/บทความ/เงินเดือน-40000-รับสุทธิเท่าไร/' },
  { query: 'เงินเดือน 50000 รับสุทธิเท่าไร', href: '/บทความ/เงินเดือน-50000-รับสุทธิเท่าไร/' },
  { query: 'เงินเดือน 50000 เสียภาษีเท่าไหร่', href: '/บทความ/เงินเดือน-50000-เสียภาษีเท่าไหร่/' },
  { query: 'เงินเดือน 60000 รับสุทธิเท่าไร', href: '/บทความ/เงินเดือน-60000-รับสุทธิเท่าไร/' },
  { query: 'เงินเดือน 15000 โอที 10 ชั่วโมง', href: '/บทความ/เงินเดือน-15000-โอที-10-ชั่วโมง/' },
  { query: 'เงินเดือน 18000 โอที 10 ชั่วโมง', href: '/บทความ/เงินเดือน-18000-โอที-10-ชั่วโมง/' },
  { query: 'เงินเดือน 30000 โอที 20 ชั่วโมง', href: '/บทความ/เงินเดือน-30000-โอที-20-ชั่วโมง/' },
  { query: 'โอที 3 เท่า คิดยังไง', href: '/บทความ/โอที-3-เท่า-คิดยังไง-2569/' },
  { query: 'BMI 23 หมายความว่าอะไร', href: '/บทความ/bmi-23-หมายความว่าอะไร/' },
  { query: 'BMI 30 หมายความว่าอะไร', href: '/บทความ/bmi-30-หมายความว่าอะไร/' },
  { query: 'สูง 160 BMI 25 หนักเท่าไร', href: '/บทความ/สูง-160-bmi-25-หนักเท่าไร/' },
  { query: 'เกิดปี 2540 อายุเท่าไร 2569', href: '/บทความ/เกิดปี-2540-อายุเท่าไร-2569/' },
  { query: 'เกิดปี 2545 อายุเท่าไร 2569', href: '/บทความ/เกิดปี-2545-อายุเท่าไร-2569/' },
  { query: 'เกิดปี 2530 อายุเท่าไร 2569', href: '/บทความ/เกิดปี-2530-อายุเท่าไร-2569/' },
  { query: '20 เปอร์เซ็นต์ของ 1000 เท่ากับเท่าไร', href: '/บทความ/20-เปอร์เซ็นต์-ของ-1000-เท่ากับเท่าไร/' },
  { query: 'ส่วนลด 30 เปอร์เซ็นต์ คิดยังไง', href: '/บทความ/ส่วนลด-30-เปอร์เซ็นต์-คิดยังไง/' },
