...
export const metaTagOptimizations: Record<string, MetaOptimization> = {
  ...
  '/คำนวณ-bmi/': {
    title: 'คำนวณ BMI 2569 | สูตรคำนวณ BMI ผู้หญิง ผู้ชาย',
    description: 'คำนวณ BMI ดัชนีมวลกายตามเกณฑ์เอเชีย พร้อมสูตรคำนวณ BMI ผู้หญิง ผู้ชาย เกณฑ์ BMI คนไทย และคำตอบ BMI 23, BMI 25, BMI 30',
    titleVariants: [
      'สูตรคำนวณ BMI ดัชนีมวลกาย เกณฑ์คนไทย 2569',
      'BMI คำนวณตัวเอง ผู้หญิง ผู้ชาย ดูว่าปกติหรือเกิน',
    ],
  },
  '/คำนวณค่าไฟฟ้า/': {
    title: '1 kWh เท่ากับกี่บาท 2569 | อัตราค่าไฟฟ้า PEA/MEA',
    description: 'คำนวณค่าไฟฟ้า PEA/MEA ปี 2569 พร้อมอัตราค่าไฟฟ้า ค่า Ft พฤษภาคม-สิงหาคม 2569 ค่าไฟห้องเช่า VAT 7% และยอดรวมทันที',
    titleVariants: [
      'อัตราค่าไฟฟ้า PEA MEA 2569 + คำนวณค่าไฟบ้าน',
      'คำนวณค่าไฟฟ้า 2569 1 kWh กี่บาท ค่า Ft ล่าสุด',
    ],
  },
  '/คำนวณเงินเดือนสุทธิ/': {
