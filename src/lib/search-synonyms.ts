...
const SEARCH_SYNONYM_RULES: SynonymRule[] = [
  {
    hrefs: ['/คำนวณค่าไฟฟ้า/'],
    terms: ['ค่าไฟ', 'ค่าไฟบ้าน', 'บิลค่าไฟ', 'บิลไฟ', 'คำนวณค่าไฟ pea', 'ค่าไฟ pea', 'ค่าไฟ 300 หน่วย', 'ค่าไฟ 500 หน่วย', 'ค่าไฟห้องเช่า', 'ค่า ft', 'ft ล่าสุด', 'pea', 'mea', 'การไฟฟ้า', '1 kwh', 'กิโลวัตต์', 'หน่วยไฟ'],
  },
  {
  ...
  },
  {
    ...
    terms: ['bmi', 'ดัชนีมวลกาย', 'น้ำหนักส่วนสูง', 'อ้วนไหม', 'ผอมไหม', 'เกณฑ์ bmi', 'bmi 23', 'bmi 25', 'bmi 30', 'สูง 160 bmi 25', 'body mass index'],
  },
  {
