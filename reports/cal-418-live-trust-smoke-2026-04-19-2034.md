# CAL-418 Live Custom-Domain Trust Smoke Check

- Run window (ICT): 2026-04-19 20:23-20:33
- Agent: Release QA Engineer Alpha
- Scope source: CAL-418 LIVE QA: Hourly custom-domain trust smoke check - 2026-04-19 20:15 ICT
...
- `reports/cal-418-local-regression-2026-04-19-2023.txt`
- `reports/cal-418-thai-formula-validation-2026-04-19T20-24-25.613+0700.json`
...
- `reports/cal-418-live-visual-www-2026-04-19-2028/manifest.json`
- `reports/cal-418-live-visual-www-2026-04-19-2028.log.txt`
- `reports/cal-418-live-visual-apex-2026-04-19-2029/manifest.json`
- `reports/cal-418-live-visual-apex-2026-04-19-2029.log.txt`
