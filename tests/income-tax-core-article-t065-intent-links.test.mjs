...
const clusterId = 'income-tax-core-article-intent-cluster';
const requiredLinks = [
  '/คำนวณภาษีเงินได้บุคคลธรรมดา/',
  '/บทความ/ภาษีเงินได้บุคคลธรรมดา-2569-คืออะไร/',
];

test('T065: intent cluster id exists exactly once', () => {
...
test('T065: intent cluster appears above first ArticleCalculatorCTA', () => {
...
test('T065: intent cluster contains both required internal links', () => {
...
test('T065: faqData wiring remains intact', () => {
