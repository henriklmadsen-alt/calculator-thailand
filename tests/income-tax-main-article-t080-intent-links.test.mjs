...
const clusterId = 'income-tax-main-article-intent-cluster';
const requiredLinks = [
  '/คำนวณภาษีเงินได้บุคคลธรรมดา/',
  '/บทความ/ภาษีเงินได้บุคคลธรรมดา-2569-คืออะไร/',
];

test('T080: intent cluster id exists exactly once', () => {
...
test('T080: intent cluster appears above first ArticleCalculatorCTA', () => {
...
test('T080: intent cluster contains both required internal links', () => {
...
test('T080: faqData wiring remains intact', () => {
