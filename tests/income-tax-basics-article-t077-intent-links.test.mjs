...
test('T077: intent cluster id exists exactly once', () => {
...
test('T077: intent cluster appears above first ArticleCalculatorCTA', () => {
...
test('T077: intent cluster contains both required internal links', () => {
...
test('T077: faqData wiring remains intact', () => {
