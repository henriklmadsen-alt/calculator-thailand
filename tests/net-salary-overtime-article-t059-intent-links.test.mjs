...
const clusterId = 'net-salary-overtime-article-intent-cluster';
const requiredLinks = [
  '/คำนวณเงินเดือนสุทธิ/',
  '/คำนวณค่าโอที/',
];

test('T059: intent cluster exists exactly once', () => {
...
test('T059: intent cluster appears above first ArticleCalculatorCTA', () => {
...
test('T059: intent cluster contains required internal links', () => {
