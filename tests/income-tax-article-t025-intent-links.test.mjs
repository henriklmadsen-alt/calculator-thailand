...
const clusterId = 'income-tax-article-intent-cluster';
const requiredLinks = [
  '/\u0e04\u0e33\u0e19\u0e27\u0e13\u0e20\u0e32\u0e29\u0e35\u0e40\u0e07\u0e34\u0e19\u0e44\u0e14\u0e49\u0e1a\u0e38\u0e04\u0e04\u0e25\u0e18\u0e23\u0e23\u0e21\u0e14\u0e32/',
  '/\u0e04\u0e33\u0e19\u0e27\u0e13\u0e40\u0e07\u0e34\u0e19\u0e40\u0e14\u0e37\u0e2d\u0e19\u0e2a\u0e38\u0e17\u0e18\u0e34/',
];

test('T025: income-tax article intent cluster section exists', () => {
  assert.match(source, new RegExp(`<section id="${clusterId}"`, 'u'));
});

test('T025: intent cluster contains both required internal links', () => {
  ...
  for (const link of requiredLinks) {
    assert.match(section, new RegExp(`href="${link}"`, 'u'));
  }
});

test('T025: intent cluster appears above first calculator CTA bridge', () => {
  ...
  assert.ok(sectionIndex < firstCtaIndex, 'intent cluster must appear above first calculator CTA bridge');
});