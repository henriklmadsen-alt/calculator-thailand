...
const clusterId = 'income-tax-deduction-article-intent-cluster';
const requiredLinks = [
  '/คำนวณภาษีเงินได้บุคคลธรรมดา/',
  '/บทความ/ภาษีเงินได้-2569-คำนวณ-วิธีลดหย่อน/',
];

test('T074: intent cluster id exists exactly once', () => {
...
test('T074: intent cluster appears above first ArticleCalculatorCTA', () => {
...
test('T074: intent cluster contains both required internal links', () => {
...
test('T074: faqData wiring remains intact', () => {
