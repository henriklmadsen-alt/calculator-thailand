...
assert.ok(fs.existsSync(filePath), 'income-tax halfyear article page not found');

const source = fs.readFileSync(filePath, 'utf8');
const clusterId = 'income-tax-halfyear-article-intent-cluster';
const requiredLinks = [
  '/คำนวณภาษีเงินได้บุคคลธรรมดา/',
  '/บทความ/ภาษีเงินได้-2569-คำนวณ-วิธีลดหย่อน/',
];

test('T071: intent cluster id exists exactly once', () => {
...
test('T071: intent cluster appears above first ArticleCalculatorCTA', () => {
...
test('T071: intent cluster contains both required internal links', () => {
...
test('T071: faqData wiring remains intact', () => {
