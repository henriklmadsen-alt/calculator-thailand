...
function findHomeLoanArticlePage() {
  const files = walkIndexFiles('src/pages');
  return files.find((filePath) => {
    const source = fs.readFileSync(filePath, 'utf8');
    return (
      source.includes('id="home-loan-article-intent-cluster"') &&
...
const filePath = findHomeLoanArticlePage();
assert.ok(filePath, 'home-loan supporting article page not found');
const source = fs.readFileSync(filePath, 'utf8');

const clusterId = 'home-loan-article-intent-cluster';
const link1 = '/\u0e04\u0e33\u0e19\u0e27\u0e13\u0e1c\u0e48\u0e2d\u0e19\u0e1a\u0e49\u0e32\u0e19/';
const link2 = '/\u0e1a\u0e17\u0e04\u0e27\u0e32\u0e21/\u0e27\u0e34\u0e18\u0e35\u0e04\u0e33\u0e19\u0e27\u0e13\u0e1c\u0e48\u0e2d\u0e19\u0e1a\u0e49\u0e32\u0e19-\u0e2a\u0e39\u0e15\u0e23\u0e41\u0e25\u0e30\u0e15\u0e31\u0e27\u0e2d\u0e22\u0e48\u0e32\u0e07\u0e08\u0e23\u0e34\u0e07/';

test('T027: home-loan article intent cluster exists', () => {
  assert.match(source, new RegExp(`<section id="${clusterId}"`, 'u'));
});

test('T027: intent cluster contains both required links', () => {
...
test('T027: intent cluster appears above first calculator CTA block', () => {
...
test('T027: faqData wiring remains intact', () => {
